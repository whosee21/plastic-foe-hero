        ...
        <div className="mt-12 pt-8 border-t border-border">
          ...
          <div className="space-y-2 text-xs text-muted-foreground">
            ...
            <div>
              ...
              <a href="https://unsplash.com/photos/FV3GConVSss" target="_blank" rel="noopener noreferrer" className="text-primary-light hover:brightness-110">Pawel Czerwinski</a> (Unsplash)
            </div>
            <div>
              <span className="font-medium">Solutions Section:</span>{' '}
              <a href="https://unsplash.com/photos/XMFZqrGyV-Q" target="_blank" rel="noopener noreferrer" className="text-primary-light hover:brightness-110">Bluewater Sweden</a> (Unsplash)
            </div>
          </div>
        </div>
      </div>
